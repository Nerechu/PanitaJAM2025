...
{
    const string privateCode = "yQ-i0riuaEyVtiCqp5uX3QjRAOeApPqUqAOspGcdzPWg";  //Key to Upload New Info
    const string publicCode = "686c01d08f40bc109c18c776";   //Key to download
